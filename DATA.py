...
def DATA_intents(text):
    ...
    return {"DATA_intents": [
        ...
        "Answers": ["من طرفدار تراکتور هستم"],
        "Actions": [],
        },
        {"Tag": "Motivate",
        "MustBeKeywords": ["فوت","مرد","مرگ"],
        "FirstLayerKeywords": [],
        "SecoundLayerKeywords": [],
        "Answers": ["زود تموم میشه","نگران نباش","زود خوب میشی"],
        "Actions": [],
        },
        {"Tag": "Motivate",
        "MustBeKeywords": ["ناراحت","غمگین","تنها"],
        "FirstLayerKeywords": [],
        "SecoundLayerKeywords": [],
        ...
        {"Tag": "Motivate",
        "MustBeKeywords": ["ناامید","بیچاره","بدبخت"],
        "FirstLayerKeywords": [],
        "SecoundLayerKeywords": [],
        ...
        {"Tag": "Motivate",
        "MustBeKeywords": ["پاره","نابود","داغون"],
        "FirstLayerKeywords": [],
        "SecoundLayerKeywords": [],
